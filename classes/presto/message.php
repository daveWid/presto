...
class Presto_Message
{
	...
	/**
	 * Echos the message in json form for AJAX calls.
	 */
	public static function ajax($type, $message)
	{
		echo json_encode( new self($type,$message) );
	}
	...
	public static function display()
	{
		...
		if( $msg ){
			self::clear();
			return View::factory('message/basic')->set('msg', $msg)->render();
		} else	{
			return '';
		}
	}
